@extends('admin.home')
    @section('content')
        ...
        <form action="/home/slider/store" enctype="multipart/form-data" method="post" style="margin-top:70px;">
            @csrf
            <div class="row form-group">
                <div class="col col-md-1"><label for="text-input" class=" form-control-label" style="padding-left:5px;">Title</label></div>
                <div class="col-12 col-md-11"><input type="text" id="text-input" name="title" placeholder="Title" class="form-control"></div>
            </div>
            <div class="row form-group">
